...
<?php get_sidebar();?>
           ...
           <section class="content">
              ...
              <div class="row">
					...
					<?php echo $error; ?>
					<form class="form-horizontal" action="<?php echo site_url('pegawai/update'); ?>" method="post" enctype="multipart/form-data">
							<div class="form-group">
							<label class="col-xs-3">NIP</label>	
							<div class="col-xs-6">
								<input type="text" name="nip" id="nip" readonly="readonly" value="<?php echo $nip; ?>" class="form-control">
						...
						<div class="form-group">
							...
							<div class="col-xs-6">
								<input type="text" name="nama_pegawai" value="<?php echo $nama_pegawai; ?>" required placeholder="Masukan Nama Pegawai" class="form-control">
						...
						<div class="form-group">
							...
							<div class="col-xs-6">
								<input type="text" id="golongan" value="<?php echo $golongan; ?>" name="golongan" required placeholder="Golongan" class="form-control">
						...
						<div class="form-group">
							...
							<div class="col-xs-6">
								<textarea cols="20" name="alamat_pegawai" class="form-control" style="overflow:scroll; height:200px;"><?php echo $alamat_pegawai; ?></textarea>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-xs-6">
								<input type="text" id="telepon" value="<?php echo $no_telepon; ?>" name="no_telepon" required placeholder="Masukan No Telepon" class="form-control">
						...
						<div class="form-group">
							...
							<div class="col-xs-6">
								<input type="text" value="<?php echo $tempat_lahir; ?>" name="tempat_lahir" required placeholder="Masukan Tempat Lahir" class="form-control">
						...
						<div class="form-group">
							...
							<div class="col-xs-6">
								<input type="text" value="<?php echo $tanggal_lahir; ?>" name="tanggal_lahir" required placeholder="Masukan Tanggal Lahir" class="datepicker form-control" />
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-xs-6">
								<input type="text" name="password" required placeholder="Masukan Password Baru" class="form-control">
