              ...
              <div class="row">
					<div class="col-md-8">
						<div class="panel panel-success">
                        	<div class="panel-heading">Edit Waktu Operasional</div>
                        		<div class="panel-body">
					<?php error_reporting(0);?>
					<?php echo $error; ?>
					<form class="form-horizontal" action="<?php echo site_url('operasional/update'); ?>" method="post">
						<input type="hidden" name="idoperasional" value="<?php echo $idoperasional ?>">
						<div class="form-group">
							<label class="col-xs-3">Tanggal Operasional</label>	
							<div class="col-xs-6">
								<input type="text" value="<?php echo $tanggal_operasional; ?>" name="tanggal_operasional" required placeholder="Masukan Tanggal Operasional" id="datepicker" class="form-control" />
							</div>
						</div>
