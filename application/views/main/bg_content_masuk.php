			...
			<div class="row">
				...
				<div class="col-md-6">
					...
					<div id="content">
						...
						<table>
							<form action="<?php echo site_url('main/save_masuk'); ?>" method="post">
								<tr>
									<td>
								...
								<tr>
							<td>
							<select type="hidden" name="akademik_idakademik" class="form-control" readonly="readonly">
								<?php
									if (count($akademik)) {
							...
							<tr>
								...
								<tr>
									<td>
										<input type="submit" class="btn1 btn-2 btn-2b" value="Submit" name="submit">
									</td>
								</tr>
							</form>
						</table>
