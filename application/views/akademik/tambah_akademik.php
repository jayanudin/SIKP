              ...
              <div class="row">
					<div class="col-md-8">
						<div class="panel panel-success">
                        	<div class="panel-heading">Input Tahun Akademik</div>
                        		<div class="panel-body">
			
					<?php error_reporting(0);?>
					<?php echo $error; ?>
					<form class="form-horizontal" action="<?php echo site_url('akademik/save'); ?>" method="post">
						<input type="hidden" name="idakademik">
						<div class="form-group">
							<label class="col-xs-3">Tahun Akademik</label>
							<div class="col-xs-6">
								<input type="text" name="tahun_akademik" required placeholder="Masukan Tahun Akademik" class="form-control">
