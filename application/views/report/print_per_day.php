              ...
              <div class="row">
					<div class="col-md-8">
						<div class="panel panel-success">
                        	<div class="panel-heading">Print Data Perhari</div>
                        		<div class="panel-body">
					<?php error_reporting(0);?>
					<?php echo $error; ?>
					<form class="form-horizontal" action="<?php echo base_url(); ?>report/print_per_day" method="post">
						...
						<div class="form-group">
							<label class="col-xs-3">Pada Tanggal</label>
							<div class="col-xs-6">
								<input type="text" name="tanggal" required placeholder="Masukan Tanggal" id="datepicker" class="form-control" />
							</div>
                        </div>
