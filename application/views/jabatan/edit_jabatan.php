...
<aside class="right-side">
           ...
           <section class="content">
              ...
              <div class="row">
					...
					<?php echo $error; ?>
					<form class="form-horizontal" action="<?php echo site_url('jabatan/update'); ?>" method="post">
						<input type="hidden" name="id_jabatan" value="<?php echo $id_jabatan ?>">

						<div class="form-group">
							<label class="col-xs-3">Jabatan</label>
							<div class="col-xs-6">
								<input type="text" name="jabatan" value="<?php echo $jabatan ?>" required placeholder="Masukan Jabatan" class="form-control">
